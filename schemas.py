"""Pydantic schemas for Adobe Real-Time CDP Connector."""
...
class ConnectParams(BaseModel):
    label: str = Field(default="", description="Friendly connection label, e.g. Primary Adobe Real-Time CDP.")
    api_token: str = Field(description="Access Token / API Key")
    base_url: str = Field(default="https://platform.adobe.io/data/core/ups", description="Adobe Real-Time CDP API base URL.")
...
class GetAudienceParams(BaseModel):
    connection_id: str = Field(default="", description="Optional connection ID.")
    audience_id: str = Field(description="Adobe Real-Time CDP Audience ID.")
