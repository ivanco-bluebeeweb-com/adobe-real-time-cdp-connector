"""Resource handlers for Adobe Real-Time CDP Connector."""
...
@chat.function("list_audiences", "List audiences in Adobe Real-Time CDP.", action_type="read", chain_callable=True, event="adobe-real-time-cdp-connector.list_audiences", effects=["read:audiences"], data_model=AudienceList)
...
@chat.function("get_audience", "Get details of one Audience in Adobe Real-Time CDP.", action_type="read", chain_callable=True, event="adobe-real-time-cdp-connector.get_audience", effects=["read:audience"], data_model=AudienceRecord)
...
@chat.function("audit_audience_health", "Audit health of Adobe Real-Time CDP audiences and connectivity.", action_type="read", chain_callable=True, event="adobe-real-time-cdp-connector.audit_audience_health", effects=["read:audit"], data_model=AuditHealthReport)
async def audit_audience_health(params: ConnectionIdParams, ctx) -> ActionResult:
    ...
    try:
        ...
        return ActionResult.ok({
            ...
            "summary": f"Adobe Real-Time CDP healthy. Sampled {len(items)} audiences."
        }, summary=f"Adobe Real-Time CDP health check passed with {len(items)} audiences.")
    except Exception as e:
        return ActionResult.error(f"Error auditing Adobe Real-Time CDP health: {e}")
