"""HTTP client for Adobe Real-Time CDP (C30. Email Marketing & Newsletter)."""
from __future__ import annotations
import httpx
from typing import Any, Optional

DEFAULT_BASE = "https://api.adobe_real_time_cdp.com"

class AdobeRealTimeCDPClient:
    def __init__(self, api_key: str, base_url: str = ""):
        ...
        self.headers = {
            ...
            "User-Agent": "Imperal-adobe_real_time_cdp/0.1.0"
        }
