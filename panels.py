"""Panel UI for Adobe Real-Time CDP Connector following UI_INTERFACE_STANDARD.md and AUTH_AND_CREDENTIALS_STANDARD.md."""
...
async def adobe_real_time_cdp_sidebar(ctx, **kwargs) -> ui.UINode:
    return ui.Stack(
        direction="v",
        gap=3,
        align="stretch",
        children=[
            ui.Text("Adobe Real-Time CDP", variant="heading"),
            ui.Stack(
                direction="v",
                gap=1,
                align="stretch",
                children=[
                    ui.Text("Manage your Adobe Real-Time CDP connections and integrations.", variant="caption"),
                ]
            ),
            ui.Divider(),
            ui.Stack(
                ...
                children=[
                    ui.Button(
                        "Sign in with Adobe Real-Time CDP (OAuth / SSO)",
                        variant="primary",
                        size="sm",
                        icon="login"
                    ),
                                ...
                                children=[
                                    ...
                                    ui.Stack(
                                        ...
                                        children=[
                                            ...
                                            ui.Input(param_name="label", placeholder="e.g. Production Adobe Real-Time CDP"),
                                        ]
                                    ),
                                    ui.Stack(
                                        direction="v",
