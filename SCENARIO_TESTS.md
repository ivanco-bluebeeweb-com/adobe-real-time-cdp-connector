# PST Testing Scenarios for Adobe Real-Time CDP Connector

## Part A: Authentication & Connectivity Verification
- **Scenario A1: Valid Credential Connect**: `connect_adobe_real_time_cdp_connector` saves token and validates endpoint.
...
- **Scenario C1: Connection Lifecycle**: Clean disconnect via `disconnect_adobe_real_time_cdp_connector` without lingering secrets.
