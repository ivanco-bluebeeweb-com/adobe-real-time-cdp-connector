"""Settings panel for Adobe Real-Time CDP Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__adobe_real_time_cdp_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=adobe_real_time_cdp_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_adobe_real_time_cdp"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("Adobe Real-Time CDP Settings & Accounts", level=2),
