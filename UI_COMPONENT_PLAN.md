# Adobe Real-Time CDP Connector — UI Component Plan
...
- **Центральная зона:** Карточки статуса подключения, таблица сущностей (Real-Time Customer Profile), журнал операций.
